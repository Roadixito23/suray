...
class _MetroMapRouteState extends State<MetroMapRoute> with SingleTickerProviderStateMixin {
  ...
  /// Carga las estaciones desde la API
  Future<void> _loadStationsFromApi() async {
    ...
    try {
      final estacionesData = await ApiService.getEstaciones();

      final stations = <Station>[];

      for (var data in estacionesData) {
      ...
      // Ordenar por km
      stations.sort((a, b) => a.km.compareTo(b.km));
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: _loadStationsFromApi,
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final double canvasHeight = canvasWidth * 4.8;
          ...
          return Stack(
            children: [
                              ...
                              ...responsiveStations.where((s) => s.isTerminal).map((terminal) {
                                return Positioned(
                                  ...
                                  child: _buildTerminal(
                                    terminal.name,
                                    terminal.km,
                                    terminal.km == responsiveStations.first.km,
                                    !isSmallScreen,
                                    isSmallScreen,
                                  ),
                                );
              ...
              if (_selectedStation != null) _buildResponsiveInfoPanel(responsiveStations, isSmallScreen),
  ...
  // Los demás métodos de widgets permanecen iguales...
  // (Copio el resto de los métodos desde el archivo original)
  ...
  Widget _buildTerminal(String text, int km, bool isStart, bool isLarge, bool isSmallScreen) {
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: isStart ? [primaryBlue, primaryBlue.withOpacity(0.8)] : [primaryOrange, primaryOrange.withOpacity(0.8)],
              ...
              return Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isSelected ? Colors.white : (station.side == 'left' ? primaryBlue : accentBlue),
...
// Clases Station y ResponsiveMetroMapPainter permanecen iguales
class Station {
  final String id;
  final String name;
...
// El ResponsiveMetroMapPainter permanece exactamente igual al original
